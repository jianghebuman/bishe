<template>
  <div class="page-container student-screen-page seeker-post-page">
    <div class="page-card student-screen-card seeker-post-card">
      <div class="header">
        <div>
          <h2>我的求职信息</h2>
      ...
      <el-divider />
      <el-form :model="form" label-width="6rem" class="post-form">
        <el-row :gutter="16">
          <el-col :xs="24" :lg="12"><el-form-item label="求职标题"><el-input v-model="form.title" placeholder="如：计算机本科求Java后端实习" /></el-form-item></el-col>
          <el-col :xs="24" :lg="12"><el-form-item label="绑定简历"><el-select v-model="form.resumeId" class="w-full" placeholder="选择在线简历"><el-option v-if="resume" :label="`在线简历（完整度 ${resume.completeRate || 0}%）`" :value="resume.id" /></el-select></el-form-item></el-col>
          <el-col :xs="24" :md="8"><el-form-item label="期望岗位"><el-input v-model="form.expectPost" /></el-form-item></el-col>
          <el-col :xs="24" :md="8"><el-form-item label="期望城市"><el-input v-model="form.expectCity" placeholder="北京,杭州" /></el-form-item></el-col>
          <el-col :xs="24" :md="8"><el-form-item label="期望薪资"><el-input v-model="form.expectSalary" placeholder="8K-12K" /></el-form-item></el-col>
      ...
      <el-table :data="attachments" stripe class="attachment-table mt-20">
...
.seeker-post-card {
  min-height:min(56rem, calc(100dvh - 8rem));
  padding:clamp(24px, 2vw, 34px);
}
.post-form :deep(.el-textarea__inner) { min-height:clamp(150px, 18vh, 220px) !important; }
...
.attachment-table { min-height:176px; }
</style>
