...
.filter-row { display: grid; grid-template-columns: minmax(5.5rem, max-content) minmax(0, 1fr); gap: .75rem; padding: .625rem 0; border-bottom: .0625rem dashed var(--cr-border-soft);
  ...
  .opt { min-height: 2.375rem; padding: .5rem 1rem; display: inline-flex; align-items: center; justify-content: center; border: .0625rem solid transparent; border-radius: 999rem; cursor: pointer; font-size: .875rem; font-weight: 720; line-height: 1; color: var(--cr-text-soft); transition: all .2s ease;
...
.portal-list-card { --portal-list-card-min-height: calc(100dvh - 21.625rem); }
