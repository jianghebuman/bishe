...
const routes = [
  // 前台门户（公共）
  {
    ...
    children: [
      ...
      { path: 'talk/:id', name: 'TalkDetail', component: () => import('@/views/portal/TalkDetail.vue'), meta: { title: '宣讲会详情' } },
      { path: 'fairs', name: 'FairList', component: () => import('@/views/portal/FairList.vue'), meta: { title: '招聘会' } },
      { path: 'fair/:id', name: 'FairDetail', component: () => import('@/views/portal/FairDetail.vue'), meta: { title: '招聘会详情' } },
