...
UPDATE `enterprise` SET `company_name` = REPLACE(`company_name`, '演示', '') WHERE `company_name` LIKE '%演示%';
UPDATE `enterprise_audit` SET `audit_remark` = REPLACE(`audit_remark`, '禁用演示状态', '禁用状态') WHERE `audit_remark` LIKE '%禁用演示状态%';
UPDATE `job_apply` SET `apply_remark` = REPLACE(`apply_remark`, '演示投递：', '') WHERE `apply_remark` LIKE '演示投递：%';
UPDATE `job_post` SET `title` = TRIM(REGEXP_REPLACE(REGEXP_REPLACE(`title`, '（[^）]*演示[^）]*）', ''), '\\([^)]*演示[^)]*\\)', '')) WHERE `title` LIKE '%演示%';
UPDATE `offer_record` SET `content` = TRIM(REGEXP_REPLACE(REGEXP_REPLACE(`content`, '（[^）]*演示[^）]*）', ''), '\\([^)]*演示[^)]*\\)', '')) WHERE `content` LIKE '%演示%';
UPDATE `offer_record` SET `position` = TRIM(REGEXP_REPLACE(REGEXP_REPLACE(`position`, '（[^）]*演示[^）]*）', ''), '\\([^)]*演示[^)]*\\)', '')) WHERE `position` LIKE '%演示%';
UPDATE `operation_log` SET `error_msg` = REPLACE(`error_msg`, '演示异常日志', '异常日志') WHERE `error_msg` LIKE '%演示异常日志%';
UPDATE `resume` SET `self_eval` = REPLACE(`self_eval`, '适合校园招聘演示', '适合校园招聘场景') WHERE `self_eval` LIKE '%适合校园招聘演示%';
UPDATE `system_notice` SET `content` = TRIM(REGEXP_REPLACE(REGEXP_REPLACE(`content`, '（[^）]*演示[^）]*）', ''), '\\([^)]*演示[^)]*\\)', '')) WHERE `content` LIKE '%演示%';
UPDATE `talent_pool` SET `remark` = REPLACE(`remark`, '演示数据：', '') WHERE `remark` LIKE '演示数据：%';

UPDATE `student`
SET `school` = CASE
  WHEN `college` IN ('人工智能学院','数据科学学院') THEN '星海数据学院'
  WHEN `college` IN ('艺术设计学院','设计学院') THEN '华东数字传媒学院'
  WHEN `college` = '经济管理学院' THEN '南城财经科技大学'
  ELSE '江南应用科技大学'
END
WHERE `school` IS NULL OR `school` = '';

UPDATE `student`
SET `student_no` = CONCAT('2026', LPAD(`id`, 6, '0'))
...
SELECT * FROM (
  SELECT 1 AS `user_id`,'ADMIN' AS `user_type`,'admin' AS `user_name`,'LOGIN' AS `log_type`,'登录' AS `module`,'管理员登录系统' AS `operation`,NULL AS `method`,NULL AS `params`,'127.0.0.1' AS `ip`,1 AS `status`,NULL AS `error_msg`,35 AS `cost_time`
  UNION ALL SELECT 1,'STUDENT','student','LOGIN','登录','学生登录系统',NULL,NULL,'127.0.0.1',1,NULL,28
  UNION ALL SELECT 1,'ADMIN','admin','OPERATION','企业管理','审核通过企业：字节跳动',NULL,NULL,'127.0.0.1',1,NULL,52
  UNION ALL SELECT 1,'ADMIN','admin','OPERATION','岗位审核','审核通过岗位：Java开发工程师','PUT /admin/job/1/audit','status=1','127.0.0.1',1,NULL,48
  UNION ALL SELECT 1,'ADMIN','admin','ERROR','导出','导出岗位数据异常示例','GET /admin/export/job','{}','127.0.0.1',0,'异常日志',103
) AS src
WHERE NOT EXISTS (
  SELECT 1
...
-- student
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (37,'demo_stu37','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','顾晓晨','江南应用科技大学','2022001037',1,'计算机学院','软件工程','2022级','本科','13920000037','demo_stu37@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (38,'demo_stu38','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','林雨薇','江南应用科技大学','2022001038',2,'计算机学院','计算机科学与技术','2022级','本科','13920000038','demo_stu38@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (39,'demo_stu39','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','许嘉豪','星海数据学院','2022001039',1,'人工智能学院','人工智能','2022级','本科','13920000039','demo_stu39@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (40,'demo_stu40','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','沈一诺','星海数据学院','2022001040',2,'数据科学学院','数据科学与大数据技术','2022级','本科','13920000040','demo_stu40@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (41,'demo_stu41','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','陈景行','江南应用科技大学','2022001041',1,'计算机学院','网络工程','2022级','本科','13920000041','demo_stu41@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (42,'demo_stu42','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','赵思琪','华东数字传媒学院','2022001042',2,'设计学院','视觉传达设计','2022级','本科','13920000042','demo_stu42@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (43,'demo_stu43','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','黄子昂','南城财经科技大学','2022001043',1,'经济管理学院','市场营销','2022级','本科','13920000043','demo_stu43@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (44,'demo_stu44','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','吴清欢','南城财经科技大学','2022001044',2,'经济管理学院','人力资源管理','2022级','本科','13920000044','demo_stu44@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (45,'demo_stu45','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','周明远','江南应用科技大学','2022001045',1,'计算机学院','软件工程','2022级','本科','13920000045','demo_stu45@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (46,'demo_stu46','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','郑语桐','星海数据学院','2022001046',2,'人工智能学院','智能科学与技术','2022级','本科','13920000046','demo_stu46@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (47,'demo_stu47','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','唐逸飞','江南应用科技大学','2022001047',1,'计算机学院','物联网工程','2022级','本科','13920000047','demo_stu47@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (48,'demo_stu48','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','冯若溪','星海数据学院','2022001048',2,'数据科学学院','信息管理与信息系统','2022级','本科','13920000048','demo_stu48@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (49,'demo_stu49','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','蒋承泽','江南应用科技大学','2022001049',1,'计算机学院','软件工程','2021级','本科','13920000049','demo_stu49@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (50,'demo_stu50','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','苏芷晴','华东数字传媒学院','2022001050',2,'设计学院','数字媒体艺术','2021级','本科','13920000050','demo_stu50@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (51,'demo_stu51','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','邹凯文','江南应用科技大学','2022001051',1,'电子信息学院','电子信息工程','2021级','本科','13920000051','demo_stu51@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (52,'demo_stu52','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','姜沐言','南城财经科技大学','2022001052',2,'经济管理学院','电子商务','2021级','本科','13920000052','demo_stu52@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (53,'demo_stu53','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','程浩然','星海数据学院','2022001053',1,'人工智能学院','人工智能','2021级','本科','13920000053','demo_stu53@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (54,'demo_stu54','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','罗诗涵','江南应用科技大学','2022001054',2,'计算机学院','计算机科学与技术','2021级','本科','13920000054','demo_stu54@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (55,'demo_stu55','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','韩亦辰','星海数据学院','2022001055',1,'数据科学学院','数据科学与大数据技术','2021级','本科','13920000055','demo_stu55@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (56,'demo_stu56','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','宋安然','南城财经科技大学','2022001056',2,'经济管理学院','会计学','2021级','本科','13920000056','demo_stu56@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (57,'demo_stu57','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','梁峻熙','江南应用科技大学','2022001057',1,'计算机学院','软件工程','2023级','硕士','13920000057','demo_stu57@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (58,'demo_stu58','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','叶知秋','星海数据学院','2022001058',2,'人工智能学院','模式识别与智能系统','2023级','硕士','13920000058','demo_stu58@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (59,'demo_stu59','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','许星河','星海数据学院','2022001059',1,'数据科学学院','统计学','2023级','硕士','13920000059','demo_stu59@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (60,'demo_stu60','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','白若宁','华东数字传媒学院','2022001060',2,'设计学院','工业设计','2023级','硕士','13920000060','demo_stu60@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (61,'demo_stu61','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','陆景川','江南应用科技大学','2022001061',1,'计算机学院','网络空间安全','2023级','本科','13920000061','demo_stu61@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (62,'demo_stu62','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','乔欣然','南城财经科技大学','2022001062',2,'经济管理学院','工商管理','2023级','本科','13920000062','demo_stu62@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (63,'demo_stu63','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','戴子墨','江南应用科技大学','2022001063',1,'电子信息学院','通信工程','2023级','本科','13920000063','demo_stu63@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (64,'demo_stu64','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','夏晚晴','江南应用科技大学','2022001064',2,'计算机学院','软件工程','2023级','本科','13920000064','demo_stu64@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
...
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (66,'demo_stu66','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','穆清越','星海数据学院','2022001066',2,'数据科学学院','数据科学与大数据技术','2023级','本科','13920000066','demo_stu66@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (67,'demo_stu67','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','石天佑','江南应用科技大学','2022001067',1,'计算机学院','计算机科学与技术','2023级','本科','13920000067','demo_stu67@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (68,'demo_stu68','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','季云舒','华东数字传媒学院','2022001068',2,'设计学院','视觉传达设计','2023级','本科','13920000068','demo_stu68@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (69,'demo_stu69','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','何以安','江南应用科技大学','2022001069',1,'电子信息学院','电子信息工程','2023级','本科','13920000069','demo_stu69@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (70,'demo_stu70','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','郝思源','江南应用科技大学','2022001070',1,'计算机学院','软件工程','2023级','本科','13920000070','demo_stu70@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (71,'demo_stu71','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','孟可欣','南城财经科技大学','2022001071',2,'经济管理学院','人力资源管理','2023级','本科','13920000071','demo_stu71@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
INSERT IGNORE INTO `student` (`id`,`username`,`password`,`real_name`,`school`,`student_no`,`gender`,`college`,`major`,`grade`,`education`,`phone`,`email`,`avatar`,`intro`,`status`,`last_login`,`create_time`,`update_time`,`deleted`) VALUES (72,'demo_stu72','$2a$10$5cl.E33gmXaCawXN8CQIi.htvEQ0FWNhkr3jv8QiixVQmIqmvITSO','杜若飞','星海数据学院','2022001072',1,'人工智能学院','人工智能','2023级','本科','13920000072','demo_stu72@stu.demo',NULL,NULL,1,NULL,'2026-06-30 23:39:34','2026-06-30 23:39:34',0);
...
-- job_post
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (44,1,128,6,'推荐算法后端工程师',1,5,'北京',22,38,'本科及以上','计算机/软件工程/人工智能','不限','参与推荐系统服务端开发，负责召回、排序、特征服务与数据链路优化。','熟悉 Java 或 Go，了解 MySQL/Redis/消息队列，有算法工程化项目经验优先。','五险一金,餐补,弹性工作,导师带教',1,NULL,1,320,3,'2026-06-28 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (45,1,129,7,'商业化前端开发工程师',1,4,'北京',18,32,'本科及以上','计算机/软件工程','不限','负责企业级增长产品前端工程建设，沉淀组件和数据看板能力。','熟悉 Vue/React、TypeScript、工程化构建，注重用户体验。','五险一金,年终奖,免费三餐,成长空间',1,NULL,1,278,3,'2026-06-27 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (46,1,130,16,'数据平台实习生',2,8,'上海',5,8,'本科及以上','数据科学/统计/计算机','不限','参与数据指标体系建设、报表开发和数据质量治理。','熟悉 SQL/Python，理解常见数据分析方法，每周至少实习4天。','实习证明,导师带教,转正机会',1,NULL,1,198,2,'2026-06-29 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (47,2,132,15,'微信生态小程序开发工程师',1,6,'深圳',20,35,'本科及以上','计算机/软件工程','不限','负责小程序基础能力、组件化和性能优化，支撑校园服务场景。','熟悉 JavaScript/TypeScript，了解前端性能优化和跨端开发。','五险一金,股票激励,班车,健身房',1,NULL,1,356,2,'2026-06-26 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (48,2,133,10,'社交产品经理管培生',1,4,'深圳',18,30,'本科及以上','不限专业','不限','参与社交产品需求分析、竞品研究、用户增长和版本迭代。','逻辑清晰、数据敏感，有校园产品或社区运营经验优先。','导师制,年终奖,弹性工作',1,NULL,1,241,4,'2026-06-28 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (49,2,131,18,'云安全工程师',1,3,'深圳',22,36,'本科及以上','网络空间安全/计算机','不限','参与云安全检测、风险处置、安全运营平台建设。','掌握网络协议、安全攻防基础，熟悉 Linux 和脚本开发。','五险一金,安全实验室,技术分享',1,NULL,1,188,2,'2026-06-25 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (50,4,134,17,'云原生平台研发工程师',1,6,'杭州',21,36,'本科及以上','计算机/软件工程','不限','参与容器平台、服务治理和自动化运维产品研发。','熟悉 Java/Go/Linux，理解 Kubernetes 基础优先。','五险一金,技术培训,餐补,弹性工作',1,NULL,1,302,3,'2026-06-27 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (51,4,135,16,'大数据开发工程师',1,5,'杭州',20,34,'本科及以上','数据科学/计算机','不限','负责离线/实时数据链路开发，建设指标体系和数据服务。','熟悉 SQL、Java/Python，了解 Flink/Spark/Hive 优先。','五险一金,年终奖,导师带教',1,NULL,1,290,2,'2026-06-29 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (52,4,136,8,'质量效能测试开发工程师',1,4,'杭州',17,28,'本科及以上','计算机/软件工程','不限','建设自动化测试平台，提升云产品质量和发布效率。','熟悉测试理论、Java/Python，有自动化测试项目经验优先。','五险一金,技术分享,补充医疗',1,NULL,1,176,2,'2026-06-24 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (53,5,137,6,'履约系统 Java 开发工程师',1,5,'北京',18,32,'本科及以上','计算机/软件工程','不限','参与即时零售、履约调度和交易系统研发。','熟悉 Java/SpringBoot/MySQL，理解高并发基础。','五险一金,餐补,弹性工作',1,NULL,1,245,2,'2026-06-28 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (54,5,138,19,'本地生活运营管培生',1,8,'上海',10,18,'本科及以上','市场营销/工商管理/不限','不限','负责商家运营、活动策划、数据复盘和增长策略落地。','沟通能力强，熟悉 Excel/数据分析，有校园活动经验优先。','五险一金,绩效奖金,成长快',1,NULL,1,231,4,'2026-06-26 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (55,10,139,9,'多模态算法工程师',1,4,'北京',25,45,'硕士及以上','人工智能/计算机/数学','不限','参与多模态模型训练、评测、推理优化和业务落地。','熟悉深度学习框架，具备 NLP/CV/多模态项目经验优先。','五险一金,论文支持,算力资源,弹性工作',1,NULL,1,389,4,'2026-06-29 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (56,10,140,6,'AI 应用后端工程师',1,6,'北京',20,34,'本科及以上','计算机/软件工程/人工智能','不限','负责 AI 应用服务、模型网关、权限和计费链路研发。','熟悉 Java/SpringBoot，了解大模型应用开发优先。','五险一金,导师带教,技术社区',1,NULL,1,267,3,'2026-06-28 23:39:34','2026-06-30 23:39:34','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (57,6,6,29,'在线教育新媒体运营',1,5,'北京',9,15,'本科及以上','新闻传播/市场营销/不限','不限','负责课程内容选题、短视频脚本、账号运营和数据复盘。','文字表达好，熟悉新媒体平台，有校园账号运营经验优先。','五险一金,带薪年假,学习资源',1,NULL,1,146,2,'2026-06-29 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (58,7,7,16,'金融数据分析师',1,4,'上海',14,24,'本科及以上','统计/金融/数据科学','不限','建设金融业务指标体系，完成用户、风控和经营分析。','熟悉 SQL/Python，具备金融业务敏感度。','五险一金,补充医疗,绩效奖金',1,NULL,1,168,2,'2026-06-28 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (59,8,8,6,'智能制造 Java 工程师',1,6,'苏州',13,22,'本科及以上','计算机/自动化','不限','参与制造执行系统、设备接入和数据采集平台研发。','熟悉 Java/SpringBoot/MySQL，有物联网项目经验优先。','五险一金,住宿补贴,项目奖金',1,NULL,1,152,2,'2026-06-27 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (60,11,11,17,'物流调度平台开发工程师',1,5,'杭州',15,26,'本科及以上','计算机/软件工程','不限','负责运力调度、路径规划和订单履约系统研发。','熟悉 Java/Go，了解分布式系统和缓存。','五险一金,餐补,弹性工作',1,NULL,1,176,2,'2026-06-26 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (61,12,12,24,'游戏 UI 视觉设计师',1,3,'上海',12,20,'本科及以上','视觉设计/数字媒体','不限','负责游戏界面、活动视觉、图标和运营素材设计。','熟练使用 Figma/PS/AI，有游戏设计作品集。','五险一金,创意奖金,弹性工作',1,NULL,1,134,2,'2026-06-25 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (62,13,13,20,'连锁餐饮电商运营',1,8,'广州',8,14,'本科及以上','电子商务/市场营销','不限','负责外卖平台、会员活动和线上渠道运营。','数据意识强，能进行活动复盘和商家沟通。','五险一金,员工餐,节日福利',1,NULL,1,128,2,'2026-06-24 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (63,14,14,27,'酒店客户服务管培生',1,10,'三亚',7,12,'大专及以上','酒店管理/旅游管理/不限','不限','参与前厅、会员、客户服务和投诉处理轮岗。','服务意识好，沟通表达清晰。','包食宿,五险一金,晋升通道',1,NULL,1,119,2,'2026-06-28 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (64,15,15,30,'门店零售储备干部',1,12,'南京',7,13,'大专及以上','工商管理/市场营销/不限','不限','负责门店运营、商品陈列、会员维护和团队排班。','执行力强，愿意从一线业务成长。','五险一金,绩效奖金,带薪培训',1,NULL,1,142,2,'2026-06-27 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (65,16,16,16,'BI 数据分析实习生',2,6,'深圳',4,7,'本科及以上','数据科学/统计/信息管理','不限','协助完成 BI 报表、数据口径梳理和专题分析。','熟悉 SQL 和 Excel，有可视化工具经验优先。','实习证明,转正机会,导师带教',1,NULL,1,155,2,'2026-06-29 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (66,17,17,23,'校园服务行政专员',1,4,'成都',6,10,'本科及以上','行政管理/人力资源/不限','不限','负责校园服务项目行政支持、资料归档和跨部门协调。','细致负责，沟通协调能力好。','五险一金,周末双休,节日福利',1,NULL,1,98,2,'2026-06-23 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (67,18,18,6,'数字化平台后端工程师',1,5,'武汉',13,24,'本科及以上','计算机/软件工程','不限','参与企业数字化平台、权限、流程引擎和报表系统研发。','熟悉 Java/SpringBoot/Vue，有业务系统开发经验优先。','五险一金,年终奖,技术分享',1,NULL,1,184,2,'2026-06-26 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (68,19,19,13,'校招 HR 助理',2,4,'广州',4,6,'本科及以上','人力资源管理/心理学','不限','协助简历筛选、面试邀约、校招活动组织和数据维护。','沟通主动，能熟练使用办公软件。','实习证明,转正机会,弹性工作',1,NULL,1,121,2,'2026-06-28 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (69,20,20,7,'零售系统前端开发',1,4,'上海',12,20,'本科及以上','计算机/软件工程','不限','负责门店运营后台、会员系统和数据看板前端开发。','熟悉 Vue/React，重视交互体验和工程质量。','五险一金,绩效奖金,弹性工作',1,NULL,1,139,2,'2026-06-24 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (70,21,21,11,'内容运营专员',1,5,'长沙',7,12,'本科及以上','新闻传播/中文/市场营销','不限','负责内容策划、用户增长活动和社区氛围维护。','文案能力强，具备热点敏感度。','五险一金,下午茶,成长空间',1,NULL,1,128,2,'2026-06-25 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (71,22,22,22,'财务管培生',1,4,'厦门',8,13,'本科及以上','会计学/财务管理','不限','参与预算、核算、经营分析和财务数字化项目。','财务基础扎实，熟悉 Excel，有初级证书优先。','五险一金,带薪年假,轮岗培养',1,NULL,1,113,2,'2026-06-27 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (72,23,23,10,'数据产品经理助理',2,3,'北京',5,8,'本科及以上','信息管理/计算机/统计','不限','协助数据产品需求调研、原型设计、验收和上线跟进。','逻辑清晰，了解 SQL 或数据分析优先。','实习证明,导师带教,转正机会',1,NULL,1,166,2,'2026-06-28 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (73,24,24,6,'SaaS 后端开发工程师',1,6,'杭州',14,25,'本科及以上','计算机/软件工程','不限','负责 SaaS 多租户、权限、消息和业务配置模块研发。','熟悉 Java/SpringBoot/MySQL，代码习惯良好。','五险一金,补充医疗,年终奖',1,NULL,1,176,2,'2026-06-29 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (74,25,25,21,'企业客户销售顾问',1,8,'上海',8,16,'本科及以上','市场营销/工商管理/不限','不限','负责企业客户线索跟进、方案讲解和合同转化。','沟通表达强，有 B 端产品理解优先。','五险一金,高提成,带薪培训',1,NULL,1,127,2,'2026-06-26 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (75,26,26,9,'图像算法实习生',2,4,'北京',6,10,'硕士优先','人工智能/计算机/数学','不限','参与图像识别、模型评估和数据集清洗工作。','熟悉 PyTorch，具备 CV 项目经验。','实习证明,论文支持,转正机会',1,NULL,1,199,2,'2026-06-28 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (76,27,27,8,'测试工程师',1,5,'西安',9,15,'本科及以上','计算机/软件工程','不限','负责 Web/API 测试、自动化脚本和质量度量。','熟悉测试流程，有接口自动化经验优先。','五险一金,双休,技术培训',1,NULL,1,143,2,'2026-06-25 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (77,28,28,19,'用户增长运营',1,6,'杭州',9,15,'本科及以上','市场营销/统计/不限','不限','负责拉新、留存、活动策略和增长实验复盘。','数据敏感，执行力强，熟悉 A/B 测试优先。','五险一金,绩效奖金,下午茶',1,NULL,1,151,2,'2026-06-24 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (78,29,29,7,'Web 前端实习生',2,5,'南京',4,7,'本科及以上','计算机/软件工程','不限','参与后台管理系统和门户页面开发。','熟悉 HTML/CSS/JavaScript，了解 Vue。','实习证明,导师带教,弹性工作',1,NULL,1,132,2,'2026-06-27 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (79,30,30,16,'经营分析专员',1,4,'重庆',8,14,'本科及以上','统计/经济/数据科学','不限','负责经营数据监控、异常分析和月度报告输出。','熟悉 SQL/Excel/PPT，表达清晰。','五险一金,双休,节日福利',1,NULL,1,122,2,'2026-06-26 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `job_post` (`id`, `enterprise_id`, `hr_id`, `category_id`, `title`, `job_type`, `recruit_num`, `city`, `salary_min`, `salary_max`, `education`, `major_require`, `experience`, `duty`, `requirement`, `welfare`, `audit_status`, `audit_remark`, `status`, `view_count`, `apply_count`, `publish_time`, `create_time`, `update_time`, `deleted`) VALUES (80,31,31,6,'后端开发工程师',1,5,'北京',15,26,'本科及以上','计算机/软件工程','不限','负责核心业务接口、任务调度和数据服务研发。','熟悉 Java/SpringBoot/Redis，理解常见设计模式。','五险一金,年终奖,技术成长',1,NULL,1,162,2,'2026-06-28 23:44:50','2026-06-30 23:44:50','2026-06-30 23:44:50',0);
...
-- offer_record
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (6,41,45,5,137,53,'履约系统 Java 开发工程师','18-32K * 14薪','北京','2026-07-15','恭喜通过 履约系统 Java 开发工程师 校招流程，请在系统内确认 Offer。',0,'2026-06-30 23:42:49','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (7,48,53,10,139,55,'多模态算法工程师','25-45K * 14薪','北京','2026-07-15','恭喜通过 多模态算法工程师 校招流程，请在系统内确认 Offer。',0,'2026-06-30 23:42:49','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (8,52,57,10,140,56,'AI 应用后端工程师','20-34K * 14薪','北京','2026-07-15','恭喜通过 AI 应用后端工程师 校招流程，请在系统内确认 Offer。',0,'2026-06-30 23:42:49','2026-06-30 23:42:49',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (9,84,39,26,26,75,'图像算法实习生','6-10K * 14薪','北京','2026-07-15','恭喜通过 图像算法实习生 招聘流程，请在系统内确认 Offer。',0,'2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (10,85,39,6,6,57,'在线教育新媒体运营','9-15K * 14薪','北京','2026-07-15','恭喜通过 在线教育新媒体运营 招聘流程，请在系统内确认 Offer。',0,'2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (11,92,43,28,28,77,'用户增长运营','9-15K * 14薪','杭州','2026-07-15','恭喜通过 用户增长运营 招聘流程，请在系统内确认 Offer。',0,'2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (12,93,43,8,8,59,'智能制造 Java 工程师','13-22K * 14薪','苏州','2026-07-15','恭喜通过 智能制造 Java 工程师 招聘流程，请在系统内确认 Offer。',0,'2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (13,100,47,30,30,79,'经营分析专员','8-14K * 14薪','重庆','2026-07-15','恭喜通过 经营分析专员 招聘流程，请在系统内确认 Offer。',0,'2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (14,101,47,12,12,61,'游戏 UI 视觉设计师','12-20K * 14薪','上海','2026-07-15','恭喜通过 游戏 UI 视觉设计师 招聘流程，请在系统内确认 Offer。',0,'2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (15,107,51,14,14,63,'酒店客户服务管培生','7-12K * 14薪','三亚','2026-07-15','恭喜通过 酒店客户服务管培生 招聘流程，请在系统内确认 Offer。',0,'2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (16,111,55,16,16,65,'BI 数据分析实习生','4-7K * 14薪','深圳','2026-07-15','恭喜通过 BI 数据分析实习生 招聘流程，请在系统内确认 Offer。',0,'2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (17,115,59,18,18,67,'数字化平台后端工程师','13-24K * 14薪','武汉','2026-07-15','恭喜通过 数字化平台后端工程师 招聘流程，请在系统内确认 Offer。',0,'2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (18,119,63,20,20,69,'零售系统前端开发','12-20K * 14薪','上海','2026-07-15','恭喜通过 零售系统前端开发 招聘流程，请在系统内确认 Offer。',0,'2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (19,123,67,22,22,71,'财务管培生','8-13K * 14薪','厦门','2026-07-15','恭喜通过 财务管培生 招聘流程，请在系统内确认 Offer。',0,'2026-06-30 23:44:50','2026-06-30 23:44:50',0);
INSERT IGNORE INTO `offer_record` (`id`, `apply_id`, `student_id`, `enterprise_id`, `hr_id`, `job_id`, `position`, `salary`, `work_city`, `report_time`, `content`, `offer_status`, `create_time`, `update_time`, `deleted`) VALUES (20,127,71,24,24,73,'SaaS 后端开发工程师','14-25K * 14薪','杭州','2026-07-15','恭喜通过 SaaS 后端开发工程师 招聘流程，请在系统内确认 Offer。',0,'2026-06-30 23:44:50','2026-06-30 23:44:50',0);
