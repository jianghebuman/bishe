...
- 2026-07-02 已移除轮播图功能，初始化脚本不再创建 `banner` 表或 `admin:banner` 权限。
- 当前数据库口径为 36 张表、425 个字段；演示数据约包含 64 家企业、77 个企业 HR、72 名学生、80 个岗位、101 条投递、18 条面试通知、20 条 Offer、54 条人才库记录。
